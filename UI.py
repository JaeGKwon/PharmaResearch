...
# Place this modified code inside the analyze_button block:
...
if analyze_button:
    if not company or not selected_subject:
        ...
        with st.status("Processing your query...", expanded=True) as status:
            ...
            try:
                final_result = recursive_query(
                    ...
                    streamlit_callback=update_ui,
                    max_concurrent_subqueries=max_concurrent_subqueries,
                ...
                # Save original result to sidebar
                st.sidebar.header("📄 Original Query Result")
                st.sidebar.text_area("Original Result", execution_result, height=500)
        ...
        # Display summarized result in main area
